...
% -----------------------------
% Se possuir orientador e coorientador, tire do comentário a parte abaixo e preencha-a (caso contrário, deixe como comentário):
% -----------------------------
\coorientador{Stephen Timoshenko}
\newcommand{\titcoorientador}{Dr. pela Universidade de Origem}
% -----------------------------
